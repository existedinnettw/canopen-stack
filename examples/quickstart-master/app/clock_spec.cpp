...
static uint32_t Obj2100_01_20 = 2; // hr
static uint8_t Obj2100_02_08 = 1;  // min
static uint8_t Obj2100_03_08 = 1;  // sec

static uint16_t Obj2200_00_10 = 0;
...
uint8_t serverId = 0x02;
const uint32_t Obj1280_01_20 = 0x600; // client -> server (tx)
const uint32_t Obj1280_02_20 = 0x580; // rx

// how to map remote 0x604100 to local 0x220000
//  const uint32_t Obj1400_01_20 = CO_COBID_RPDO_DEFAULT(0); // para: rpdo num
const uint32_t Obj1400_01_20 = 0x00000182;
...
const uint32_t Obj1A00_03_20 = CO_LINK(0x2100, 0x03, 8);  // sec
